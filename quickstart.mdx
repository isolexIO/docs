---
title: "Quickstart"
description: "To build or run the project, dependencies include:

Python 3.6+
Standard Python modules: base64, hashlib, json, re, unittest
Optionally: Bitcoin Core tools for reference"
---
...
` git clone <repo-url> cd bluchip-source # install dependencies (if applicable)`
